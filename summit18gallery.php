...
<head>
    ...
    <meta property="og:url" content="http://bcisummit.com/index.html">
...
<nav class="main-menu">
    ...
    <nav class="head">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <div class="logo">
                            <a href="/"><img src="assets/img/logo-temp-2.png" style="height:45px" alt="BCI Summit"></a>
                        </div>
                    </div>
                    <div class="col-md-9 text-right">
                        <nav>
                        <ul>
                        <!--<li><a href="bcisummit2018.html">BCI Summit 2018</a></li> --><li><a href="events.html">Events</a></li><li><a href="membership.html">Membership</a></li><li><a href="/researchers.html">Researchers</a></li><li><a href="sponsor.html">Sponsor</a></li><li><a href="speakers.html">Speakers</a></li>
                        <li><a href="/summit-2020-cto-edition.html">BCI Summit CTO/CIO</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
    ...
    <section class="section-padding about-us-page abo about-page">
        <div class="container">
    		...
    		?>
    				<li class="col-xs-6 col-sm-4 col-md-3" data-src="assets/img/galleryS2018/<?php echo $image;?>" data-sub-html="<h4>BCI Summit 2019</h4><p>Bringing together world's greatest minds in blockchain and digital asset investments</p>" data-pinterest-text="Pin it1" data-tweet-text="share on twitter 1">
	                    <a href="">
	                        <img class="img-responsive" src="assets/img/galleryS2018/<?php if(file_exists('assets/photo/thumb/'.$image)==1){echo 'thumb/'.$image;}else{echo $image;} ?>" alt="" />
	                    </a>
	                </li>
	        <?php
            	}
