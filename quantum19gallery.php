...
<html lang="zxx">
<head>
    <title>BCI Summit Quantum | Gallery</title>
...
<!--Header section end-->
    ...
    <section class="section-padding about-us-page abo about-page">
        <div class="container">
    		...
    		?>
    				<li class="col-xs-6 col-sm-4 col-md-3" data-src="assets/img/galleryQ2019/<?php echo $image;?>" data-sub-html="<h4>BCI Summit</h4><p>2019</p>" data-pinterest-text="Pin it1" data-tweet-text="share on twitter 1">
	                    <a href="">
	                        <img class="img-responsive" src="assets/img/galleryQ2019/<?php if(file_exists('assets/img/galleryQ2019/thumb/'.$image)==1){echo 'thumb/'.$image;}else{echo $image;} ?>" alt="" />
	                    </a>
	                </li>
	        <?php
            	}
