<?php
	$dir = "assets/img/gallery-portfolio/";
	$file_list = [];
	$directory_list = [];
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
                <h1>Digital Asset Portfolio Growth, Banking and Custody</h1>
            </div>
        </div>
    </div>
</section>
<!--Header section end-->
    ...
    <section class="section-padding about-us-page abo about-page">
        <div class="container">
    		...
    		?>
    				<li class="col-xs-6 col-sm-4 col-md-3" data-src="assets/img/gallery-portfolio/<?php echo $image;?>" data-sub-html="<h4>Digital Asset Portfolio Growth, Banking and Custody</h4>" data-pinterest-text="Pin it1" data-tweet-text="share on twitter 1">
	                    <a href="">
	                        <img class="img-responsive" src="assets/img/gallery-portfolio/<?php if(file_exists('assets/img/gallery-portfolio/thumb/'.$image)==1){echo 'thumb/'.$image;}else{echo $image;} ?>" alt="" />
	                    </a>
	                </li>
	        <?php
            	}
