<?php
	$dir = "assets/img/gallery-liquidity-exchng/";
	$file_list = [];
	$directory_list = [];
...
<meta itemprop="addressLocality" content="New York, NY">
    ...
    <script>
        window.ChatraSetup = {
            ...
            buttonPosition: window.innerWidth < 1024? 'bc': 'br'
        };
        (function(d, w, c) {
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 text-center">
                <h1>Digital Asset Liquidity, Exchanges and ETFs</h1>
            </div>
        </div>
    </div>
</section>
<!--Header section end-->
    ...
    <section class="section-padding about-us-page abo about-page">
        <div class="container">
    		...
    		?>
    				<li class="col-xs-6 col-sm-4 col-md-3" data-src="assets/img/gallery-liquidity-exchng/<?php echo $image;?>" data-sub-html="<h4>Digital Asset Liquidity, Exchanges and ETFs</h4>" data-pinterest-text="Pin it1" data-tweet-text="share on twitter 1">
	                    <a href="">
	                        <img class="img-responsive" src="assets/img/gallery-liquidity-exchng/<?php if(file_exists('assets/img/gallery-liquidity-exchng/thumb/'.$image)==1){echo 'thumb/'.$image;}else{echo $image;} ?>" alt="" />
	                    </a>
	                </li>
	        <?php
            	}
...
<footer style="padding-top: 10px !important;" class="footer-section section-padding padding-bottom-0">
