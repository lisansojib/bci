<?php
	$dir = "assets/img/galleryEA072018/";
	$file_list = [];
	$directory_list = [];
	...
	<section class="breadcrumb-section contact-bg section-padding pastE">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9 text-right">
                        <nav>
                            <ul>
                        <li><a href="bcisummit2018.html">BCI Summit 2018</a></li> <li><a href="events.html">Events</a></li><li><a href="sponsor.html">Sponsor</a></li><li><a href="speakers.html">Speakers</a></li><li><a href="press.html">MEDIA</a></li><li><a href="summit-2019.html">BCI Summit 2019 Tickets</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
                <h1>Growth and Opportunities in Arts with Blockchain</h1>
            </div>
        </div>
    </div>
</section>
<!--Header section end-->
    ...
    <section class="section-padding about-us-page abo about-page">
        <div class="container">
    		...
    		?>
    				<li class="col-xs-6 col-sm-4 col-md-3" data-src="assets/img/galleryEA072018/<?php echo $image;?>" data-sub-html="<h4>Charity Event</h4><p>Growth and Opportunities in Arts with Blockchain</p>" data-pinterest-text="Pin it1" data-tweet-text="share on twitter 1">
	                    <a href="">
	                        <img class="img-responsive" src="assets/img/galleryEA072018/<?php if(file_exists('assets/img/galleryEA072018/thumb/'.$image)==1){echo 'thumb/'.$image;}else{echo $image;} ?>" alt="" />
	                    </a>
	                </li>
	        <?php
            	}
